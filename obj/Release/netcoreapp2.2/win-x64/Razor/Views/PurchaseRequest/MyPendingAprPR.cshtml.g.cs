#pragma checksum "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "beeaa9e08186738e709f5d5133bbf4ee29485fec"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"beeaa9e08186738e709f5d5133bbf4ee29485fec", @"/Views/PurchaseRequest/MyPendingAprPR.cshtml")]
    ...
    <script>
        ...
        function PRDetails(RequisitionHeaderId) {
           ...
           $(""#tabel6"").DataTable({
                ...
                footerCallback: function (row, data, start, end, dis");
                WriteLiteral(@"play) {
        ...
        <div class=""modal-dialog modal-lg"">
            <div class=""modal-content"">
                ...
                <div class=""modal-body"">
                    ");
                EndContext();
                BeginContext(10109, 4544, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "beeaa9e08186738e709f5d5133bbf4ee29485fec14932", async() => {
                    BeginContext(10125, 82, true);
                    WriteLiteral("\r\n                        <fieldset id=\"SubmitForm\">\r\n                            ");
                    EndContext();
                    BeginContext(10208, 89, false);
#line 258 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                       Write(Html.HiddenFor(a => a.HeaderTbl.RequisitionHeaderId, new { @id = "RequisitionHeaderId" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(10297, 156, true);
                    WriteLiteral("\r\n                            <div class=\"form-group\">\r\n                                <label>Purchase Request No</label>\r\n                                ");
                    EndContext();
                    BeginContext(10454, 127, false);
#line 261 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                           Write(Html.TextBoxFor(a => a.HeaderTbl.RequisitionNo, new { @id = "RequisitionNo", @class = "form-control", @readonly = "readonly" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(10581, 244, true);
                    WriteLiteral("\r\n                            </div>\r\n                            <div class=\"form-row\">\r\n                                <div class=\"col-md-6\">\r\n                                    <label>Requester</label>\r\n                                    ");
                    EndContext();
                    BeginContext(10826, 123, false);
#line 266 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                               Write(Html.TextBoxFor(a => a.HeaderTbl.RequesterId, new { @id = "RequesterID", @class = "form-control", @readonly = "readonly" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(10949, 197, true);
                    WriteLiteral("\r\n                                </div>\r\n                                <div class=\"col-md-6\">\r\n                                    <label>Department</label>\r\n                                    ");
                    EndContext();
                    BeginContext(11147, 145, false);
#line 270 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                    ...
                    WriteLiteral(@"
                            ...
                            <div class=""form-row"">
                                <div class=""col-md-6"">
                                    ...
                                    ");
                    EndContext();
                    BeginContext(11578, 144, false);
#line 276 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                               Write(Html.TextBoxFor(a => a.HeaderTbl.OrderDate, new { Type = "datetime-local", @id = "OrderDate", @class = "form-control", @readonly = "readonly" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(11722, 195, true);
                    WriteLiteral("\r\n                                </div>\r\n                                <div class=\"col-md-6\">\r\n                                    <label>Due Date</label>\r\n                                    ");
                    EndContext();
                    BeginContext(11918, 140, false);
#line 280 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                               Write(Html.TextBoxFor(a => a.HeaderTbl.DueDate, new { Type = "datetime-local", @id = "DueDate", @class = "form-control", @readonly = "readonly" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(12058, 218, true);
                    WriteLiteral("\r\n                                </div>\r\n                            </div>\r\n                            <div class=\"form-group\">\r\n                                <label>Notes</label>\r\n                                ");
                    EndContext();
                    BeginContext(12277, 126, false);
#line 285 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
                           Write(Html.TextAreaFor(a => a.HeaderTbl.RequestNotes, new { @id = "RequestNotes", @class = "form-control", @readonly = "readonly" }));

#line default
#line hidden
                    EndContext();
                    BeginContext(12403, 241, true);
                    WriteLiteral("\r\n                            </div>\r\n                            <div class=\"form-row\">\r\n                                <div class=\"col-md-6\">\r\n                                    <label>Status</label>\r\n                                    ");
                    EndContext();
                    BeginContext(12645, 182, false);
#line 290 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
...
#line hidden
                    EndContext();
                    BeginContext(12827, 195, true);
                    WriteLiteral("\r\n                                </div>\r\n                                <div class=\"col-md-6\">\r\n                                    <label>Priority</label>\r\n                                    ");
                    EndContext();
                    BeginContext(13023, 188, false);
#line 294 "D:\ASP.NET Program\03-07-2019\Balimoon E-Procurement\Views\PurchaseRequest\MyPendingAprPR.cshtml"
